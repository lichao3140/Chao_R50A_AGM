...
public class QueryAppConfig implements RequestHandler {
    ...
    public void handle(HttpRequest request, HttpResponse response, HttpContext context) throws HttpException, IOException {
        ...
        //是否开启1:1
        boolean isOpen1_1 = SPUtil.getBoolean(Const.KEY_ISOPEN1_1, Const.OPEN_1_1);
        map.put(Const.KEY_ISOPEN1_1, isOpen1_1);

        //是否开启1:n
        boolean isOpen1_N = SPUtil.getBoolean(Const.KEY_ISOPEN1_N, Const.OPEN_1_N);
        map.put(Const.KEY_ISOPEN1_N, isOpen1_N);
       ...
       // map.put(Const.KEY_ISOPENMUSIC, isOpenMusic);
        ...
        //IP
        String ip = SPUtil.getString(Const.KEY_VMSIP, "192.168.1.200");
