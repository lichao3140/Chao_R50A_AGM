...
public class Const {
   ...
   // public static float comper_socre_1 = 0.45f;//1：1阈值
    ...
    public static String DEVICE_PASS = "000000";//设备终端密码
    /**
     * 是否注册人脸标志位
     */
   ...
   //建模错误信息
    ...
    public static final String KEY_ISOPEN1_1 = "isopen1_1";
    public static final String KEY_ISOPEN1_N = "isopen1_N";
     ...
     * 默认开启1:1
     */
    public static final boolean OPEN_1_1 = false;
    /**
     * 默认开启1:N
     */
    public static final boolean OPEN_1_N = true;
